<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="view_formularios_admin" %>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <p class="lead">Aca podras configurar Todos nuestros Servicios.</p>
        </div>
    </div>
    <%--   navbar--%>
